  ...
  return (
    <div name='about' className='text-gray-700  bg-white w-full h-[400px] '>
      <div className='flex flex-col justify-center items-center w-full h-full'>
          <div className='border-2 border-gray-700  p-1 rounded-lg px-4 hover:scale-110 duration-500 '>
              <p className='text-1xl sm:text-3xl md:text-4xl font-bold inline  mb-10'>About</p>
          </div>

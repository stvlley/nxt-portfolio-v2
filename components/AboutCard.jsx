...
export default function AboutCard() {
  return (
    <div name='about' className='text-gray-600  bg-white w-full h-[400px] '>
      <div className='flex flex-col justify-center sm:items-center w-full h-full'>
          <div className='border-2  shadow-md shadow-gray-400  border-gray-700  p-1 rounded-lg px-3 mx-6 hover:scale-110 duration-500 '>
